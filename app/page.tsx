...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 transition-colors flex flex-col items-center py-12">
      ...
      <ProductGrid products={deckProducts} title="FAR-OUT DECKS" />
      <ProductGrid products={accessoryProducts} title="FAR-OUT ACCESSORIES" />

      {/* Footer Section */}
      <footer className="w-full py-12 bg-white dark:bg-zinc-950 dark:text-white flex flex-col items-center text-center transition-colors">
        <p className="text-lg mb-4">Thank you for shopping With</p>
        <div className="relative w-32 h-32 mb-6">
          <LogoAnimation />
        </div>
        <div className="flex flex-col items-center space-y-2">
          <a href="https://www.youtube.com/channel/Far-OutSkateboards-it1iy" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 hover:text-black dark:text-gray-400 dark:hover:text-white" aria-label="Visit our YouTube channel">
          ...
          <a href="https://www.instagram.com/far_out_skateboards" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 hover:text-black dark:text-gray-400 dark:hover:text-white" aria-label="Visit our Instagram profile">
            <svg className="h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
